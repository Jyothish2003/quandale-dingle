package com.jk.simplewallpaper.adapters;
...
import com.jk.simplewallpaper.activities.WallpaperActivity;
import com.jk.simplewallpaper.models.WallsPOJO;
...
public class WallsAdapter extends RecyclerView.Adapter<WallsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // Handling for regular wallpaper layout
        if (viewType == 1) {
            view = inflater.inflate(R.layout.walls_layout, parent, false);
        }
        // Handling for loading layout with full-screen behavior
        else if (viewType == 3) {
            view = inflater.inflate(R.layout.loading_layout_full, parent, false);
        }
        // Handling for loading layout (standard)
        else {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, int viewType) {
            ...
            // Remove the 'else if' block handling adView for viewType == 2
            // as you no longer have ads in the layout.
        }
